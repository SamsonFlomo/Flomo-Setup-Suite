...
import ConfigureNetwork from "./actions/ConfigureNetwork.js";
import JoinDomain from "./actions/JoinDomain.js";
import GenerateReport from "./actions/GenerateReport.js";

class AutomationManager {
  constructor() {
    this.actions = {
      rename_computer: RenameComputer,

      create_user: CreateUser,

      install_software: InstallSoftware,

      install_printer: InstallPrinter,

      create_admin: CreateAdmin,

      configure_network: ConfigureNetwork,
  ...
  createTask(type, data) {
    const action = this.getAutomation(type);
